...
def load_config(): 
    ...
    SHEET_TAB_1 = os.getenv("SHEET_TAB_1", "Shree Anjani Couriers")
    SHEET_TAB_2 = os.getenv("SHEET_TAB_2", "DTDC Couriers")
    SHEET_TAB_3 = os.getenv("SHEET_TAB_3", "Shree Maruti Couriers")
